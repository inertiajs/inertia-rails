...
Rails.application.routes.draw do
  ...
  get 'conditional_get' => 'inertia_render_test#conditional_get'
  get 'conditional_partial' => 'inertia_render_test#conditional_partial'
  get 'conditional_strong' => 'inertia_render_test#conditional_strong'
  get 'conditional_last_modified' => 'inertia_render_test#conditional_last_modified'
  get 'conditional_stale' => 'inertia_render_test#conditional_stale'
  ...
  get 'my_external_location' => 'inertia_test#my_external_location'
  get 'external_redirect_test' => 'inertia_test#external_redirect_test'
  put 'external_redirect_test' => 'inertia_test#external_redirect_test'
  ...
  get 'api_external_redirect_test' => 'inertia_api_test#external_redirect'
  ...
  get 'server_head_meta' => 'inertia_server_head#basic'
  get 'server_head_empty_meta' => 'inertia_server_head#empty'
  get 'server_head_collision_meta' => 'inertia_server_head#collision'
  get 'server_head_collision_without_meta' => 'inertia_server_head#collision_without_meta'
  get 'server_head_collision_deferred_meta' => 'inertia_server_head#collision_deferred'
